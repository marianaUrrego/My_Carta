...
public class SedesActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng colombia = new LatLng(4.6, -83.4);

        // Add a marker in Sydney and move the camera
        LatLng medellin = new LatLng(6.3, -75.7);
        LatLng envigado = new LatLng(5.3, -75.7);
        LatLng sabaneta = new LatLng(4.3, -75.7);
        LatLng bello = new LatLng(4.3, -75.7);
